<html>
    ...
    <body class="p1">
        ...
        <form method="GET" action="../calc-main/" class="p2">
            ...
            <fieldset style="margin-right: 1000;">                
                ...
                <input type="radio" name="op" value="subtração">Subtração</input><br>
                <input type="radio" name="op" value="multiplicação" checked>Multiplicação</input><br>
